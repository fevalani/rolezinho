    ...
    <div className={styles.page}>
      <div className={styles.heroSection}>
        ...
        <div className={`${styles.logoContainer} anim-bounce`}>
          <svg viewBox="0 0 200 200" width={160} height={160} className={styles.logo}>
            <defs>
            ...
            />
            {/* Inner detail lines */}
            <line x1="100" y1="30" x2="100" y2="170" stroke="#c9a55a" strokeWidth="0.5" opacity="0.1" />
            <line x1="30" y1="100" x2="170" y2="100" stroke="#c9a55a" strokeWidth="0.5" opacity="0.1" />
            {/* D20 text */}
            <text
              x="100"
              y="92"
        ...
        <h1 className={`${styles.greeting} anim-fade d2`}>
          Olá, {firstName}
        </h1>
      ...
      <div className={`${styles.featureGrid} container`}>
        {APP_FEATURES.map((feat, i) => (
          ...
          >
            ...
            {!feat.enabled && <span className={styles.comingSoon}>Em breve</span>}
